...
import 'package:my_journal_app_server/src/generated/journal_entry.dart' as _i7;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    ...
    connectors['journal'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'saveEntry': _i1.MethodConnector(
          name: 'saveEntry',
          params: {
            'entry': _i1.ParameterDescription(
              name: 'entry',
              type: _i1.getType<_i7.JournalEntry>(),
              nullable: false,
            ),
          },
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['journal'] as _i5.JournalEndpoint).saveEntry(
                    session,
                    params['entry'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['journal'] as _i5.JournalEndpoint).getAllEntries(
                    session,
                    params['userId'],
                  ),
        ),
