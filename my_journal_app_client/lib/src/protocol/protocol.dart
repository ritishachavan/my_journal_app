...
import 'journal_entry.dart' as _i3;
import 'user_info.dart' as _i4;
import 'package:my_journal_app_client/src/protocol/journal_entry.dart' as _i5;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i3.JournalEntry) {
      return _i3.JournalEntry.fromJson(data) as T;
    }
    if (t == _i4.UserInfo) {
    ...
    if (t == _i1.getType<_i3.JournalEntry?>()) {
      return (data != null ? _i3.JournalEntry.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i4.UserInfo?>()) {
      return (data != null ? _i4.UserInfo.fromJson(data) : null) as T;
    }
    if (t == List<_i5.JournalEntry>) {
      return (data as List)
              .map((e) => deserialize<_i5.JournalEntry>(e))
              .toList()
          as T;
    }
    try {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'JournalEntry') {
      return deserialize<_i3.JournalEntry>(data['data']);
    }
